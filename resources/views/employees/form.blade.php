...
@section('page-title', isset($employee) ? 'Edit Data Karyawan' : 'Tambah Karyawan Baru')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="salary_type" class="form-select @error('salary_type') is-invalid @enderror">
                            <option value="monthly" {{ old('salary_type', $employee->salary_type ?? 'monthly') == 'monthly' ? 'selected' : '' }}>Bulanan</option>
